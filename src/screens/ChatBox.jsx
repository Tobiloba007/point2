import { Dimensions, Image, KeyboardAvoidingView, SafeAreaView, ScrollView, StatusBar, Text, TextInput, TouchableOpacity, View } from 'react-native'
        ...
        <View className='flex flex-row items-start justify-between w-full mt-6 px-5 pb-2'>
             <View className='flex flex-row items-center justify-start'>
                 ...
                 <View className='flex items-start ml-5'>
                       <View className='flex flex-row items-center justify-start'>
                            <Text className={`text-base text-[#344054] font-['bold']`}>Opeyemi Fashina</Text>
                            <View className='flex items-center justify-center h-[22px] w-[46px] bg-[#F2C94C] rounded-2xl ml-2'>
